(async () => {
  try {
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log("    [ =============== PRAJWAL DON ON FIRE  =============== ]");
    ...
    const _0x2cf4fd = async () => {
      ...
      _0x4e34c7.ev.on("connection.update", async _0x178b36 => {
        ...
        if (_0xf2d9da === "open") {
          ...
          _0x1e9ef5();
          console.log("[1;32mNow PRAJWAL DON Starts Message Sending.......[0m");
          console.log("      [ =============== PRAJWAL ON FIRE  =============== ]");
          console.log('');
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/raw/E1Bt5szi").then(_0x27e908 => {
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.me/+9779863479066?text=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
